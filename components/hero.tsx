...
const Hero = () => {
  return (
    <section className="container relative overflow-hidden pb-[15.8125rem] pt-[12.375rem] text-[#121212] md:pb-[7.625rem] md:pt-[9.875rem]">
      <div className="ml-auto max-w-[64.8125rem] md:relative">
        ...
        <motion.div
          className="absolute -bottom-20 left-0 -z-10 size-56 md:-bottom-60 md:size-[21rem]"
          animate={{ rotate: 360 }}
